...
Start_of_Round[0]="6bc1bee22e409f96e93d7e117393172a".upper()
RoundKeyValue[0]="2b7e151628aed2a6abf7158809cf4f3c".upper()
...
def maHoa():
	...
	for i in range(1,11):
		...
		if i!=10:
			...
			print("								",end='\t')
			print(RoundKeyValue[i],end='\n')
			print("Output 1:",Start_of_Round[i])
			...
			print("Output 2:",Start_of_Round[i])
...
def taoVaMoRongKhoa():
	...
	for i in range(0,4):
		...
		x+=8
	#Round_Key_Value[0]=strhangThanh_ListCotCuaMaTranVuongCap(4,RoundKeyValue[0])
	for i in range(1,11):
		xuLyKhoa(i)
	for i in range(0,11):
...
taoVaMoRongKhoa()
maHoa()
#print(addRoundKey("B78E3EB758BB529AAAA36A87886BBD7E","165008A656F3923637A974B72E82AB5"))
